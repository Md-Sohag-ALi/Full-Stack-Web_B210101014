...
kidnapped.innerHTML = "Zayed is Kidnapped"
kidnapped[0].innerContent = "<h2>Zyed is Kidnpped</h2>"
kidnapped[0].innerHTML = "<h1>Zyed is Kidnpped</h1>"

function colorBG()
{
const lalala_item = document.getElementById("lalala")
 /*lalala_item.style.backgroundColor = "red" */
lalala_item.textContent = "Hahah! You have  been kidnapped"

}

//colorBG()

    const kidnapped_button = document.getElementById("button_id")
    kidnapped_button.addEventListener("mouseover" , colorBG)
